...
RSpec.describe "place_sports/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit place_sport form" do
    render

    assert_select "form[action=?][method=?]", place_sport_path(@place_sport), "post" do
